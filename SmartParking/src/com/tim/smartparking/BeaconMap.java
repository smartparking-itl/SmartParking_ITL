 ...
 */
public class BeaconMap extends Activity {

  private static final String TAG = BeaconMap.class.getSimpleName();
    ...
    beaconManager.connect(new BeaconManager.ServiceReadyCallback() {
      ...
      public void onServiceReady() {
        try {
          ...
          Toast.makeText(BeaconMap.this, "Cannot start ranging, something terrible happened",
